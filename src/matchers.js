...
const isLocalModuleFromParentDirectory = (exports.isLocalModuleFromParentDirectory = (
  path
) => path.startsWith(PARENT_DIRECTORY_PREFIX));

const isLocalModuleCurrentDirectoryIndex = (exports.isLocalModuleCurrentDirectoryIndex = (
  path
) => path === CURRENT_DIRECTORY_PREFIX);

exports.isLocalModule = (path) =>
  path.startsWith(PARENT_DIRECTORY_PREFIX) ||
